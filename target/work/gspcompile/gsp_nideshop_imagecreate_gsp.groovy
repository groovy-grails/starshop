...
class gsp_nideshop_imagecreate_gsp extends GroovyPage {
...
invokeTag('form','g',35,['enctype':("multipart/form-data"),'url':([resource:imageInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1537862619164L
