		...
		<div id="list-nideshopGoods" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="goodsDesc" title="${message(code: 'nideshopGoods.goodsDesc.label', default: 'Goods Desc')}" />
						...
						<g:sortableColumn property="addTime" title="${message(code: 'nideshopGoods.addTime.label', default: 'Add Time')}" />
				...
				<g:each in="${nideshopGoodsInstanceList}" status="i" var="nideshopGoodsInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: nideshopGoodsInstance, field: "goodsDesc")}</td>
						...
						<td>${fieldValue(bean: nideshopGoodsInstance, field: "addTime")}</td>
