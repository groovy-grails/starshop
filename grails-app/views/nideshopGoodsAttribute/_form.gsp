...
<div class="fieldcontain ${hasErrors(bean: nideshopGoodsAttributeInstance, field: 'attributeId', 'error')} required">
	...
	<g:select id="attributeId" name="attributeId.id" from="${nideshop.NideshopGoodsAttribute.list()}" optionKey="id" required="" value="${nideshopGoodsAttributeInstance?.attributeId?.id}" class="many-to-one"/>
