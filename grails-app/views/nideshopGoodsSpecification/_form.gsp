...
<div class="fieldcontain ${hasErrors(bean: nideshopGoodsSpecificationInstance, field: 'specificationId', 'error')} required">
	...
	<g:select id="specificationId" name="specificationId.id" from="${nideshop.NideshopSpecification.list()}" optionKey="id" required="" value="${nideshopGoodsSpecificationInstance?.specificationId?.id}" class="many-to-one"/>
