			...
			<ol class="property-list nideshopGoodsSpecification">
				...
				<li class="fieldcontain">
					<span id="specificationId-label" class="property-label"><g:message code="nideshopGoodsSpecification.specificationId.label" default="Specification Id" /></span>
						...
						<span class="property-value" aria-labelledby="specificationId-label"><g:link controller="nideshopGoodsSpecification" action="show" id="${nideshopGoodsSpecificationInstance?.specificationId?.id}">${nideshopGoodsSpecificationInstance?.specificationId?.encodeAsHTML()}</g:link></span>
