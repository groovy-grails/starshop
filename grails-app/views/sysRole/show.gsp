	...
	<body>
		...
		<div id="show-sysRole" class="content scaffold-show" role="main">
			...
			<ol class="property-list sysRole">
				...
				<g:if test="${sysRoleInstance?.authority}">
				<li class="fieldcontain">
					<span id="authority-label" class="property-label"><g:message code="sysRole.authority.label" default="Authority" /></span>
					
						<span class="property-value" aria-labelledby="authority-label"><g:fieldValue bean="${sysRoleInstance}" field="authority"/></span>
